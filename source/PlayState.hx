...
class PlayState extends MusicBeatState
{
	...
	private function generateSong(dataPath:String):Void
	{
		...
		{
			//some 5note changes
			var mn:Int = keyAmmo[mania]*2; //new var to determine max notes
	...
	override public function update(elapsed:Float)
	{
		...
		//LITTLE CHEAT CODE BECAUSE I NEVER BEAT GOD-EATER AND I SUCK AT 9K CHARTS LOL
		#if debug
		...
		if (generatedMusic)
			{
				...
				{	
					...
					daNote.y -= (daNote.burning ? ((curStage != 'sky' && FlxG.save.data.downscroll) ? 185 : 65 ) : 0);
	...
	//I NEVER HAVE BEATEN GOD-EATER AND I SUCK AT 9K CHARTS LOL
	...
	override function stepHit()
	{
		...
		if (SONG.song.toLowerCase() == 'god-eater' && curStep != stepOfLast)
		{
			switch(curStep)
			{
				case 1:
